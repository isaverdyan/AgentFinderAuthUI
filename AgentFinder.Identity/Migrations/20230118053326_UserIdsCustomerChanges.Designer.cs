...
namespace AgentFinder.Identity.Migrations
{
    ...
    [Migration("20230118053326_UserIdsCustomerChanges")]
    partial class UserIdsCustomerChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgentFinder.Identity.Models.AgentInterestsLocation", b =>
                {
                    ...
                    b.ToTable("AgentInterestsLocation", (string)null);
                });
            ...
            modelBuilder.Entity("AgentFinder.Identity.Models.Customer", b =>
                {
                    ...
                    b.Property<string>("SpecialSecription")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AgentFinder.Identity.Models.AgentInterestsLocation", b =>
                {
                    ...
                    b.HasOne("AgentFinder.Identity.Models.User", "UserId")
                        .WithMany("agentInterestsLocations")
            ...
            modelBuilder.Entity("AgentFinder.Identity.Models.User", b =>
                {
                    b.Navigation("agentInterestsLocations");
                });
